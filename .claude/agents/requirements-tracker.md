...
- **Data & Storage** — persistence, databases, file formats, data lifecycle
- **Security** — auth, encryption, access control, secrets
- **API & Integration** — endpoints, protocols, external services
- **Session & Orchestration** — session lifecycle, mixins, workflows
- **Discovery & Search** — vector search, schema discovery, indexing
- **UI & Frontend** — components, stores, user interaction
- **Infrastructure** — config, deployment, logging, monitoring
- **Testing & Quality** — test strategy, coverage, CI
- **LLM & AI** — prompts, providers, model integration
- **Domain Model** — entities, glossary, relationships, tiers
